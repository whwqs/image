        ...
        for i in range(10):
            ...
            if key in templateDic:
                ...
                try:            
                    ...
                    return "模板出错，请检查配置文件:"+ str(i)  
            res = cv2.matchTemplate(region, t_ , cv2.TM_CCOEFF_NORMED)
...
if __name__== '__main__':
    functype = "code"#sys.argv[1]
    imgpath = "20190329_150621.bmp"#sys.argv[2]
    name = "黄鹤楼"#sys.argv[3]    
    if functype == "barcode":
        print(getBarcode(imgpath,name)[0])
    else:        
        print(getCode2(imgpath,name))
